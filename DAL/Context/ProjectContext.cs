   ...
   public class ProjectContext:DbContext
    {
        ...
        {
            Database.Connection.ConnectionString = "Server=Naso;Database=ETicaret;Integrated Security=True;";
        }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new DisLikeMap());
        ...
        public DbSet<LikeMap> Likes { get; set; }
